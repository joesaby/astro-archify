...
Archify's own `agent-run.lifecycle.json` example (reused here under Archify's MIT license). Ordered lifecycle phases with human gates, recovery loops, and terminal exits.
  ...
  "meta": {
    ...
    "views": [
      ...
      },
      {
        ...
        "note": "See where the run pauses without becoming terminal."
      },
      {
        "id": "recovery-and-exits",
        "label": "Recovery and terminal exits",
        "focus": [
          "executing",
          "failed",
          "blocked",
        ...
        "note": "Separate retryable failure from cancellation and expiry."
      }
    ]
  },
  "lanes": [
